<?php /* Smarty version Smarty-3.1.8, created on 2014-10-20 23:06:53
         compiled from "/opt/lampp/htdocs/ristoranet/modules/mobile/views/comanda/update_catalogo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13448304245445796d165b65-97263165%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e0804f7334077848a33a34c12279a26c1f3acff7' => 
    array (
      0 => '/opt/lampp/htdocs/ristoranet/modules/mobile/views/comanda/update_catalogo.tpl',
      1 => 1410110271,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13448304245445796d165b65-97263165',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5445796d2a1004_96810023',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5445796d2a1004_96810023')) {function content_5445796d2a1004_96810023($_smarty_tpl) {?><style type="text/css">
/*
 * Base structure
 */
...
public/img/menu/'+datos[i].imagen+'"></div><div class="col-md-5"><legend>Papitas pal Loro</legend></div><div class="col-md-5"><button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." id="descripcion">Descripción</button></div><div class="col-md-1 "><h3 class="text-center">'+datos[i].precio+'</h3><p class="text-center"><button type="button" class="btn btn-primary" onclick="agregar('+datos[i].cod+');">Agregar</button></p></div></div></div>');
            }
